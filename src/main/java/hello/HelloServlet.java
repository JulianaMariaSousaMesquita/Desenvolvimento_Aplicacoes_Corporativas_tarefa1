...
public class HelloServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");         
            out.println("<div class=\"container\"> <div class=\"row\"> <h1> <div class=\"col-md-9 ms-md-auto\">" +ola+nome+ "!</h1></div>"+"<div class=\"col-md-9 ms-md-auto\">Horario:"+calendar.get((Calendar.HOUR_OF_DAY))+"</div><a href=\"https://infinite-savannah-77606.herokuapp.com/\" class=\"btn btn-primary btn-lg disabled\" role=\"button\" aria-disabled=\"true\">Voltar</a> </div></div>");            
            out.println("</body>");
            out.println("</html>");
        }
    }
